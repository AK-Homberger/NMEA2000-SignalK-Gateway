...
In the [main programm](https://github.com/AK-Homberger/NMEA2000-SignalK-Gateway/tree/main/NMEA2000-SignalK-Gateway), you have to change the WLAN information to allow the ESP32 to connect to you WLAN network.
